{{--
    ...
    Displays a meaning and its possible words as multiple choice options
    Features:
    - Shows the target meaning
...
<div class="container mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-[var(--secondary-text-clr)]">Choose the correct word of the meaning:</p>
        <p class="text-2xl font-semibold text-[var(--text-clr)]">{{ $word->meaning }}</p>
    </div>
